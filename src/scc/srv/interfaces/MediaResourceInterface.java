...
public interface MediaResourceInterface {
     ...
     * @param filename - name used to store the file on storage being uploaded (TODO
     *                 could be passed as
     *                 Query Param!)
     * @return a string confirming that was uploaded (Should be changed in the
     *         future)
     */
    @POST
    @Path("/{filename}")
    ...
    public String upload(byte[] contents, @PathParam("filename") String filename);
